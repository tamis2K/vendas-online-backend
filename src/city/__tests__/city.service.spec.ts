...
describe('CityService', () => {
  ...
  it('should return findeOne city', async () => {
    const city = await service.findCityById(cityMock.id);

    expect(city).toEqual(cityMock);
  });

  it('should return error findeOne not found', async () => {
  ...
  it('should return  Cities in getAllcitesByStateId', async () => {
    const city = await service.getAllcitesByStateId(cityMock.id);
